'''
Тесты, которые были даны вместе с заданием
Проверяют работоспособность /import, /nodes, /delete
В функциях проверки /updates и /nodes/../history стоят заглушки
(просто проверка на status code - 200)
'''

# encoding=utf8
from test_data.data import API_BASEURL
import json
import re
import subprocess
import sys
